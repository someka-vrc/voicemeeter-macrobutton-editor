...
import { MacroButtonConfiguration, MB_MIDI, MB_TRIGGER, MB_XINPUT, MB_GPIO, VBHIDMapItem } from "./types/macroButton";
...
export const defaultMacroButton: MacroButtonConfiguration = {
  id: uuidv4(),
  "@_index": 0,
  "@_type": "0",
  "@_color": "0",
